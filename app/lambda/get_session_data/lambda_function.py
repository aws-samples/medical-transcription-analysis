...
class GetSessionDataLambda(LambdaBase):
    ...
    def handle(self, event, context):
        try:
            ...
            soap_key = self.getKeyName(sessionId,'soap','txt')
            ...
            result = {'comprehend': (comprehend_result['Body'].read()).decode("utf-8"), 'transcribe': (transcribe_result['Body'].read()).decode("utf-8"), 'soap': (soap_result['Body'].read()).decode("utf-8")}
