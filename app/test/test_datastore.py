...
class TestDataStore(unittest.TestCase):
    ...
    def test_save(self):
        ...
        response = d.save(SESSION_INFO_1, 'us-west-2')
    ...
    def test_save_empty(self):
        table = self.create_session_table()
        d = DataStore('dynamodb', 'Sessions', 'PatientId', 'SessionId')
        response = d.save(SESSION_INFO_EMPTY, 'us-west-2')
    ...
    def test_save_multiple(self):
        ...
        d = DataStore('dynamodb', 'Sessions', 'PatientId', 'SessionId')
        d.save(SESSION_INFO_1, 'us-west-2')
        response = table.scan()
        self.assertEqual(1, len(response['Items']))
        d.save(SESSION_INFO_2, 'us-west-2')
        response = table.scan()
        self.assertEqual(2, len(response['Items']))
        d.save(SESSION_INFO_3, 'us-west-2')
        response = table.scan()
    ...
    def test_save_collision(self):
        ...
        response = d.save(SESSION_INFO_1_SAMEKEY, 'us-west-2')
        self.assertEqual('OK', response['status'])
        response = table.scan()
        self.assertEqual(1, len(response['Items']))
    ...
    def test_list_items(self):
        ...
        d = DataStore('dynamodb', 'Sessions', 'PatientId', 'SessionId')
        d.save(SESSION_INFO_1, 'us-west-2')
        response = d.listItems('us-west-2')
    ...
    def test_query_by_both_keys_nonexistent(self):
        ...
        d.save(SESSION_INFO_2, 'us-west-2')
        d.save(SESSION_INFO_3, 'us-west-2')
        response = d.queryByBothKeys('p-0', 's-1', 'us-west-2')
        self.assertEqual(len(response),0)
        response = d.queryByBothKeys('p-5', 's-1', 'us-west-2')
        self.assertEqual(len(response),0)
        response = d.queryByBothKeys('p-1', 's-0', 'us-west-2')
        self.assertEqual(len(response),0)
        response = d.queryByBothKeys('p-0', 's-0', 'us-west-2')
        self.assertEqual(len(response),0)
